package kg.alatooitclub.fullstack.vaadin.crmtest.views.admincontrol_users;
...
@PageTitle("Admin/control_users")
@Route(value = "admin/control_users", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class Admincontrol_usersView extends Div {
    ...
    public Admincontrol_usersView() {
        addClassName("admincontrolusers-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
